    ...
    return (
        ...
        <div >
            {haveError ? <div className="flex flex-col items-center w-full pt-4 pb-16">
                <Link href="/">  <button className="z-80 bg-orange-500 hover:bg-orange-600 text-white font-black text-2xl py-2 px-4 rounded-full h-16 w-full">back to home</button>
                </Link> </div> : ""}
